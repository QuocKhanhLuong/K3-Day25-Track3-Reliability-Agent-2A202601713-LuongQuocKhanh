...
class ReliabilityGateway:
    """Route requests through cache, circuit breakers, providers, and static fallback."""
    ...
    def complete(self, prompt: str) -> GatewayResponse:
        """Return the first successful response and record the route taken."""
        ...
        return GatewayResponse(
            ...
            latency_ms=0.0,
            estimated_cost=0.0,
            error=last_error or "No provider was available",
        )
